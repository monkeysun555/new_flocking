...
def plot_entropy(entropys):
    ...
    # plt.yticks(np.arange(0, 30.1, 5), fontsize=28)
    plt.yticks(np.arange(0, 1.00001, 0.5), fontsize=28)
    plt.ylabel('Accuracy', fontsize=24)
    plt.xlabel('Time (s)', fontsize=28)
    plt.axis([0, x_upper, 0, 1])
    plt.tight_layout()
    plt.close()
...
def plot_fov(time, yaw, pitch):
    ...
    plt.plot([x - offset for x in time], pitch, linestyle='-', color='chocolate', label="Pitch", linewidth=2, alpha=0.9)
    # plt.plot(new_rate_seg, new_rate, color='chocolate', label="Effective Rates", linewidth=2, alpha=0.9)
...
def main():
    ...
    p.savefig(figure_path + 'coor2'+ '_latency' + str(OPTIMIZE) + '_fov.eps', format='eps', dpi=1000, figsize=(20, 5))
    ...
    p.savefig(figure_path + 'coor2' + '_latency' + str(OPTIMIZE) + '_ratio.eps', format='eps', dpi=1000, figsize=(20, 5))
    ...
    p.savefig(figure_path + 'coor2'+ '_latency' + str(OPTIMIZE) + '_buffer.eps', format='eps', dpi=1000, figsize=(20, 5))
    ...
    p.savefig(figure_path + 'coor2' + '_latency' + str(OPTIMIZE) + '_entropys.eps', format='eps', dpi=1000, figsize=(20, 5))
    ...
    p.savefig(figure_path + 'coor2' + '_latency' + str(OPTIMIZE) + '_freezes.eps', format='eps', dpi=1000, figsize=(20, 5))
