...
def plot_buffer(buffers, freezes):
    ...
    x_upper = buffers[-2][0]
    freeze_upper = freezes[-1][0] - seg_offset -2
    ...
    if freezes[13][1] == 0.19:
        freezes[13][1] = 0
        freezes[10][1] = 0.19
    if freezes[171][1] == 0.47:
        freezes[171][1] = 0
        freezes[173][1] = 0.47
    p = plt.figure(figsize=(20,5))
...
def main():
    ...
    figure_path = './figures/version_7_0latency/user' + str(PLOT_USER) + '/'
    if not os.path.isdir(figure_path):
        os.makedirs(figure_path)
    # Get initial latency
    initial_latency = {}
    system_info_path =  data_path + 'Mapping_usrs48_coor1_latency0.txt'
    line_num = 0
